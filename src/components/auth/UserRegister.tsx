...
import { Mail, Lock, Eye, EyeOff, Chrome, ArrowLeft, User, AlertCircle, CheckCircle } from 'lucide-react';
...
export default function UserRegister({ onClose, onSwitchToLogin, onRegisterSuccess }: UserRegisterProps) {
  ...
  const handleEmailRegister = async (e: React.FormEvent) => {
    ...
    try {
      const { user } = await UserAuthService.registerWithEmail(
        formData.email,
        formData.password,
