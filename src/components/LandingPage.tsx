...
export default function LandingPage() {
  ...
  const customizeProduct = (product: any) => {
    dispatch({ type: "SET_SELECTED_PRODUCT", payload: product });
  ...
  const nextBestSellers = () => {
    setBestSellersIndex((prev) => (prev + 1) % bestSellersProducts.length);
  };

  const prevBestSellers = () => {
    setBestSellersIndex(
      (prev) =>
        (prev - 1 + bestSellersProducts.length) % bestSellersProducts.length,
    );
  };

  const nextNewArrivals = () => {
    setNewArrivalsIndex(
      (prev) => (prev + 1) % Math.max(1, newArrivalsProducts.length - 5),
    );
  };

  const prevNewArrivals = () => {
    setNewArrivalsIndex((prev) => Math.max(0, prev - 1));
  };
  ...
  const bestSellersProducts = [
    {
      ...
      isPopular: true,
      description:
        "Elegant wedding frame perfect for capturing your special day memories.",
      features: [
        "Premium oak wood",
        "UV-resistant glass",
    ...
    },
    {
      ...
      description:
        "Beautiful family portrait frame for your cherished family moments.",
      features: [
    ...
    },
    {
      ...
      isPopular: true,
      description:
        "Adorable frame perfect for baby's first photos and milestones.",
      features: [
        "Baby-safe materials",
        "Soft pastel colors",
    ...
    },
    {
      ...
      image:
        "https://images.pexels.com/photos/1128318/pexels-photo-1128318.jpeg",
      description:
        "Multi-photo collage frame perfect for anniversary celebrations.",
      features: [
        "Holds 6 photos",
  ...
  const newArrivalsProducts = Array.from({ length: 8 }, (_, index) => ({
    id: `new-${index + 1}`,
    title: `Premium Frame #${index + 1}`,
    category: "All",
    rating: 4.5 + (index % 5) * 0.1,
    reviews: 50 + index * 10,
    originalPrice: 29.99 + index * 10,
    salePrice: null,
    image: `https://images.pexels.com/photos/${1762851 + index}/pexels-photo-${1762851 + index}.jpeg`,
    description: `New arrival premium frame with modern design and quality craftsmanship.`,
    features: [
      "Modern design",
      "Quality materials",
      "Easy installation",
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section
        id="hero"
        className="relative bg-gradient-to-br from-blue-50 to-white overflow-hidden"
      >
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                ...
                <p className="text-xl text-gray-600 leading-relaxed">
                  Transform your precious memories into stunning personalized
                  photo frames. From weddings to birthdays, capture every
                  special moment with our premium custom frames.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Perfect frames for every special moment
            </p>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-6">
            {[
              ...
              >
                <div
                  className={`w-20 h-20 ${category.bg} rounded-full flex items-center justify-center mx-auto mb-3 group-hover:shadow-lg`}
                >
                  {category.icon}
                </div>
          ...
          <div className="mb-16">
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className="p-2 rounded-full bg-gray-100 hover:bg-gray-200 transition-colors"
                    disabled={
                      bestSellersIndex === bestSellersProducts.length - 1
                    }
                  >
                    <ChevronRight
                      size={20}
            ...
            <div className="relative overflow-hidden">
              <div
                ...
                style={{ transform: `translateX(-${bestSellersIndex * 25}%)` }}
              >
                  ...
                  <div key={product.id} className="w-1/4 flex-shrink-0 px-3">
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300 group">
                      ...
                      >
                        ...
                        <button className="absolute bottom-3 right-3 w-8 h-8 bg-white rounded-full flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity shadow-md">
          ...
          <div>
              ...
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    disabled={
                      newArrivalsIndex >=
                      Math.max(0, newArrivalsProducts.length - 6)
                    }
                  >
                    <ChevronRight
                      size={20}
            ...
            <div className="relative overflow-hidden">
              <div
                className="flex transition-transform duration-300 ease-in-out"
                style={{
                  transform: `translateX(-${newArrivalsIndex * (100 / 6)}%)`,
                }}
              >
                {newArrivalsProducts.map((product, index) => (
                  <div key={product.id} className="w-1/6 flex-shrink-0 px-2">
                    <div className="bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow duration-300 group">
                      ...
                      <div className="p-3">
                        <h3
                          className="font-medium text-gray-900 text-sm mb-1 cursor-pointer hover:text-blue-600 transition-colors line-clamp-2"
                          onClick={() => viewProduct(product)}
                        >
                          {product.title}
                        </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="text-white space-y-6">
              ...
              <p className="text-xl text-blue-100">
                Mix and match any frames from our collection. Perfect for
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Over 10,000 five-star reviews from happy customers
            </p>
          </div>
            ...
            {[
              {
                ...
                content:
                  "Absolutely stunning quality! The frame perfectly captured our wedding day memories. The attention to detail is incredible and shipping was super fast.",
                rating: 5,
                image:
                  "https://images.pexels.com/photos/1128318/pexels-photo-1128318.jpeg",
              },
              {
                ...
                content:
                  "I've ordered multiple frames for our family photos. Each one is crafted with such care and precision. Highly recommend for anyone wanting premium quality.",
                rating: 5,
                image:
                  "https://images.pexels.com/photos/1762851/pexels-photo-1762851.jpeg",
              },
              {
                ...
                content:
                  "The customization options are amazing! I was able to create the perfect frame for my daughter's first birthday photos. Customer service was exceptional too.",
                rating: 5,
                image:
                  "https://images.pexels.com/photos/1128318/pexels-photo-1128318.jpeg",
              },
      ...
      <section id="about" className="py-16 bg-white">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Everything you need to know about our frames
            </p>
          </div>
            ...
            {[
              {
                ...
                answer:
                  "Most orders are processed within 2-3 business days and shipped via express delivery. You'll receive tracking information once your order ships.",
              },
              {
                question: "What materials do you use for your frames?",
                answer:
                  "We use premium materials including solid oak, walnut wood, and high-grade aluminum. All frames come with UV-resistant glass and acid-free matting.",
              },
              {
                question: "Can I customize the size of my frame?",
                answer:
                  "Yes! We offer standard sizes from 4x6 to 16x20, plus custom sizing options. Our design tool will help you find the perfect fit for your photo.",
              },
              {
                question: "What's your return policy?",
                answer:
                  "We offer a 30-day satisfaction guarantee. If you're not completely happy with your frame, we'll provide a full refund or replacement.",
              },
              {
                question: "Do you offer bulk discounts for large orders?",
                answer:
                  "Yes! Contact our customer service team for special pricing on orders of 10 or more frames. Perfect for events, businesses, or gifts.",
              },
            ].map((faq, index) => (
              <div
                key={index}
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              See how our customers display their beautiful frames
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-gray-300 leading-relaxed">
                ...
                most precious memories. With premium materials and expert
                craftsmanship, every frame tells your unique story.
              </p>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-4">
                Get exclusive offers and framing tips
              </p>
          ...
          <div className="border-t border-gray-800 mt-12 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="flex items-center space-x-4">
                ...
                <div className="flex space-x-2">
                  {["PayPal", "Visa", "Mastercard", "RuPay", "UPI"].map(
                    (payment) => (
                      <div
                        key={payment}
                        className="bg-gray-800 px-3 py-1 rounded text-xs text-gray-300"
                      >
                        {payment}
                      </div>
                    ),
